...
<div class="main">
	...
	<form action="abc.html" method="post">
		...
		<h1 style="font-size:9mm;">Customer Sign Up</h1>

		<fieldset>
			<label for="Enter first name">First Name:</label> <input type="text"
				name="fname" maxlength="32" pattern="^[a-zA-Z][a-zA-Z-_\.]{4,20}$"
				placeholder="Firstname must contain 5 to 20 characters."
				required="required"> <label for="Enter last name">Last
			...
			<input type="text" name="userName"
				placeholder="Username must contain 5 to 20 characters."
				pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{5,20}$" required="required">
