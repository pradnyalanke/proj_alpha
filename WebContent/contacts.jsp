    ...
    <div class="container_12">
      <div class="grid_6">
        ...
        <div class="map">
          ...
          <dl>
            <dt>
              <p>Institute for Advance Computing And Software Development,<br>
              Sector No 29,Nigdi Pradhikaran, Akurdi,Pune</p>
            </dt>
            <dd><span>Freephone:</span>+91 7588 707 853</dd>
            <dd><span>Telephone:</span>+91 9403 600 341</dd>
      ...
      <div class="bottom_block">
        ...
        <div class="grid_6">
          ...
          <form id="newsletter" action="#">
            <div class="success">Your subscribe request has been sent to the server!</div>
            <label class="email">
...
<footer>
  <div class="container_12">
    <div class="grid_12"> Delish on the Go   | <a href="#">Privacy Policy</a> | Design by: <a href="#">DelishOnTheGo.com</a> </div>
    <div class="clear"></div>
  </div>
</footer>
</body>
